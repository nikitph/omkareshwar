      ...
      <Router>
        <Scene key='drawer' component={NavigationDrawer} open={false}>
          <Scene key='drawerChildrenWrapper' navigationBarStyle={Styles.navBar} titleStyle={Styles.title} leftButtonIconStyle={Styles.leftButton} rightButtonTextStyle={Styles.rightButton}>
            <Scene initial key='presentationScreen' component={PresentationScreen} title='ॐ' renderLeftButton={NavItems.hamburgerButton} />
            ...
            <Scene key='legend' component={legend} title='Legend' />
            <Scene key='transport' component={transport} title='Transportation' />
